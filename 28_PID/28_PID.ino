...
// Servo adjustment
#define _DUTY_NEU 1600  // Servo angle: 0 degree 1700
#define _DUTY_MAX 2600  // 아래로 가는 각
#define _DUTY_MIN 500  // 위로 가는 각
...
{
  return  605 + -2 * a_value + 1.66E-03 * a_value * a_value;; // Replace this with the equation obtained from nonlinear regression analysis
}
