...
#define _DUTY_MIN 810   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 120 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // 서보 속도 제한 (unit: degree/second)

#define _BANGBANG_RANGE 400 // 서보 뱅뱅 범위

// 전역 변수 정의, 필터값, ema, 탁구공과의 거리 정의
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 404 - 1.3 * a_value + 1.08E-03 * a_value * a_value;
}
